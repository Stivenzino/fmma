...
const ROLE_ATTRS = {
  /* ── GOALKEEPERS ──────────────────────────────────────────────────────── */
  'Goalkeeper': {
    key: ['Reflexes','Handling','Positioning'],
    imp: ['Agility','Aerial','Decisions'],
    sec: ['Communication','Strength','Technique'],
  },
  'Sweeper Keeper': {
    key: ['Reflexes','Agility','Kicking'],
    imp: ['Handling','Positioning','Decisions'],
    sec: ['Throwing','Technique','Pace'],
  },
  ...
  'Ball-Playing Defender': {
    ...
    imp: ['Technique','Decisions','Strength'],
    sec: ['Aerial','Pace','Creativity'],
  },
  'No-Nonsense Centre-Back': {
    key: ['Tackling','Strength','Aerial'],
    imp: ['Positioning','Aggression','Decisions'],
    sec: ['Leadership','Stamina','Teamwork'],
  },
  'Wide Centre-Back': {
    key: ['Tackling','Positioning','Pace'],
    imp: ['Strength','Aerial','Decisions'],
    sec: ['Passing','Stamina','Teamwork'],
  },
  'Sweeper': {
    key: ['Positioning','Tackling','Decisions'],
    imp: ['Strength','Aerial','Teamwork'],
    sec: ['Pace','Stamina','Leadership'],
  },
  'Libero': {
    key: ['Positioning','Decisions','Passing'],
    imp: ['Tackling','Technique','Creativity'],
    sec: ['Pace','Stamina','Strength'],
  },

  /* ── FULL-BACKS & WING-BACKS ──────────────────────────────────────────── */
  'Full-Back': {
    key: ['Tackling','Positioning','Stamina'],
    imp: ['Pace','Teamwork','Crossing'],
    sec: ['Strength','Passing','Decisions'],
  },
  'Defensive Full-Back': {
    key: ['Tackling','Positioning','Strength'],
    imp: ['Aerial','Decisions','Teamwork'],
    sec: ['Pace','Stamina','Passing'],
  },
  'Inverted Full-Back': {
    key: ['Tackling','Positioning','Decisions'],
    imp: ['Passing','Strength','Teamwork'],
    sec: ['Technique','Pace','Stamina'],
  },
  'Wing-Back': {
    key: ['Crossing','Pace','Stamina'],
    imp: ['Dribbling','Technique','Teamwork'],
    sec: ['Tackling','Passing','Movement'],
  },
  'Inverted Wing-Back': {
    key: ['Passing','Technique','Decisions'],
    imp: ['Tackling','Positioning','Stamina'],
    sec: ['Dribbling','Teamwork','Creativity'],
  },

  /* ── DEFENSIVE MIDFIELDERS ────────────────────────────────────────────── */
  'Defensive Midfielder': {
    key: ['Tackling','Positioning','Teamwork'],
    imp: ['Stamina','Decisions','Passing'],
    sec: ['Strength','Aggression','Technique'],
  },
  'Anchor': {
    key: ['Positioning','Tackling','Decisions'],
    imp: ['Strength','Teamwork','Aggression'],
    sec: ['Passing','Stamina','Aerial'],
  },
  'Ball-Winning Midfielder': {
    key: ['Tackling','Aggression','Stamina'],
    imp: ['Strength','Positioning','Teamwork'],
    sec: ['Decisions','Aerial','Passing'],
  },
  'Deep-Lying Playmaker': {
    key: ['Passing','Creativity','Technique'],
    imp: ['Decisions','Teamwork','Stamina'],
  ...
  'Wide Midfielder': {
    key: ['Crossing','Pace','Stamina'],
    imp: ['Passing','Technique','Teamwork'],
    sec: ['Tackling','Positioning','Dribbling'],
  },
  'Winger': {
    key: ['Crossing','Dribbling','Pace'],
    imp: ['Technique','Movement','Stamina'],
    sec: ['Passing','Decisions','Creativity'],
  },
  'Defensive Winger': {
    key: ['Stamina','Tackling','Crossing'],
    imp: ['Pace','Positioning','Teamwork'],
    sec: ['Technique','Passing','Decisions'],
  },
  'Inverted Winger': {
    key: ['Dribbling','Passing','Pace'],
    imp: ['Technique','Creativity','Movement'],
    sec: ['Crossing','Shooting','Stamina'],
  },
  ...
  'Attacking Midfielder': {
    key: ['Passing','Creativity','Technique'],
    imp: ['Movement','Shooting','Decisions'],
    sec: ['Dribbling','Pace','Stamina'],
  },
  'Advanced Playmaker': {
    key: ['Passing','Creativity','Decisions'],
    imp: ['Technique','Dribbling','Teamwork'],
    sec: ['Movement','Pace','Stamina'],
  },
  'Inside Forward': {
    key: ['Dribbling','Shooting','Pace'],
    imp: ['Movement','Technique','Creativity'],
    sec: ['Passing','Stamina','Decisions'],
  },
  'Trequartista': {
    key: ['Creativity','Technique','Dribbling'],
    imp: ['Passing','Decisions','Movement'],
    sec: ['Shooting','Pace','Teamwork'],
  },
  'Shadow Striker': {
    key: ['Shooting','Movement','Pace'],
    imp: ['Technique','Dribbling','Decisions'],
    sec: ['Passing','Stamina','Teamwork'],
  },
  ...
  'Poacher': {
    ...
    sec: ['Aerial','Strength','Teamwork'],
  },
  'Advanced Forward': {
    key: ['Shooting','Movement','Pace'],
    imp: ['Technique','Dribbling','Strength'],
    sec: ['Passing','Decisions','Aerial'],
  },
  'Deep-Lying Forward': {
    key: ['Passing','Technique','Decisions'],
    imp: ['Creativity','Strength','Teamwork'],
    sec: ['Shooting','Movement','Dribbling'],
  },
  'Target Forward': {
    key: ['Strength','Aerial','Teamwork'],
    imp: ['Positioning','Stamina','Shooting'],
  ...
  'Pressing Forward': {
    key: ['Stamina','Aggression','Tackling'],
    imp: ['Teamwork','Strength','Pace'],
    sec: ['Shooting','Movement','Decisions'],
  },
};
  ...
  scored.forEach(({ player, top }) => {
    ...
    slot.innerHTML = `
      <div class="bench-name-row">
        <span class="bench-name">${truncate(player.name, 10)}</span>
